                ...
                <NavLink
                    ...
                    className={({ isActive }) => (isActive 
						...
						: `${todo.done 
							...
							: 'bg-red-500/70 hover:bg-red-500 transition-all duration-500'} navlink-list`)}
                >    
					<div className="flex justify-start items-center w-full">
						<small className="bg-white text-3xl p-1 rounded-full"><TodoDoneSymbol todo={todo}/></small>
						<small className="mx-4 break truncate font-light">{todo.todoTitle}</small>
					</div>
                </NavLink>
            ))}
        </ul>
