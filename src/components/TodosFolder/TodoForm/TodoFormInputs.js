    ...
    return (
        <>
            <form
                ...
                className="flex flex-col justify-center items-center lg:items-center gap-4 h-1/2 bg-white/50 rounded-b-2xl p-4 mx-4 
            ...
            >
                ...
                <label htmlFor="descri" className="form-label">Description</label>
                <textarea
            ...
            <h2 className={`${formVal ? 'animate-pulse' : 'opacity-0' } font-bold text-red-500 mt-4 text-xl text-center 
...
TodoFormInputs.propTypes = {
    handleSubmitForm: PropTypes.func.isRequired,
    todoForm: PropTypes.object.isRequired,
    setTodoForm: PropTypes.func.isRequired,
    formVal: PropTypes.bool.isRequired
};
